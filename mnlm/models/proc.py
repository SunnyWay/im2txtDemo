...
def process():
    ...
    """
    ##################################
    train_captions = 'mnlm/models/iaprtc12/train_captions.txt'
    train_images = 'mnlm/models/iaprtc12/train_hidden7.txt'
    test_captions = 'mnlm/models/iaprtc12/test_captions.txt'
    test_images = 'mnlm/models/iaprtc12/test_hidden7.txt'
    context = 5
    ##################################
