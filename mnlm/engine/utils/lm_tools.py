...
def compute_ngrams(sequence, n):    # return all the n tuples, a list of lists. a caption relative to a list
    """
...
# swtich the words in n or n-1 tuples to its index according to word_dict
# if include_last = True, return n tuples version, else return n-1 tuple version
# if include_index = True, return (instance, index), else return instance
# instance[i] is the index version of the i-th tuple
# index[i] represents the i-th tuple belongs to which caption
